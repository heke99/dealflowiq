  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="lg:pl-72">
        <header className="sticky top-0 z-20 hidden border-b border-white/10 bg-slate-950/90 px-6 py-3 backdrop-blur lg:block">
          <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4">
            <div>
              <div className="text-xs uppercase tracking-wide text-slate-500">Workspace</div>
              <div className="text-sm font-semibold text-slate-200">{organizationName || 'Organization'}</div>
            </div>
            <div className="flex items-center gap-3">
              <Link href="/notifications" className="rounded-xl border border-white/10 px-4 py-2 text-sm font-semibold text-slate-200 hover:bg-white/10">Notifications</Link>
              <Link href="/settings" className="rounded-xl border border-white/10 px-4 py-2 text-sm font-semibold text-slate-200 hover:bg-white/10">Profile</Link>
              <form action={signOutAction}>
                <button className="rounded-xl bg-white px-4 py-2 text-sm font-semibold text-slate-950 hover:bg-slate-200">Sign out</button>
              </form>
            </div>
          </div>
        </header>
