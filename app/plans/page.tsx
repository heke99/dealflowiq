  ...
  return (
    <form action={savePlanAction} className="space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-5">
        ...
        <label className="block text-sm"><span className="text-slate-300">Trial days</span><input name="trial_days" type="number" min="0" defaultValue={Number(plan?.trial_days ?? 7)} className="mt-2 w-full rounded-xl border border-white/10 bg-slate-900 px-4 py-3" /></label>
        ...
        <section className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-blue-500/15 via-slate-950 to-emerald-500/10 p-6 sm:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-slate-300">Create plans, edit limits, delete plans safely, and sync organization subscriptions from one place. New non-admin users get a clear 7-day full-access trial. After trial end, access is restricted until payment/subscription is active or a member override is granted.</p>
            </div>
            <div className="grid gap-3 sm:grid-cols-3 lg:min-w-[520px]">
              ...
              <div className="rounded-3xl border border-emerald-400/20 bg-emerald-400/10 p-4"><div className="text-xs text-emerald-100/70">Usable access</div><div className="mt-1 text-3xl font-black text-emerald-100">{numberText(activeSubs)}</div><div className="text-xs text-emerald-100/70">Latest 40 shown</div></div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.035] p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-slate-400">Set price, included features, limits and trial days. Default is 7 days for normal new signups; platform admins never use trial access.</p>
              </div>
            </div>
